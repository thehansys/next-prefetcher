...
import { RuleValidatorsAndExtensions, AsyncRuleValidatorsAndExtensions } from './RuleValidators';
...
export declare type BaseValueValidators<TModel, TValue> = {
...
export declare type AsyncBaseValueValidators<TModel, TValue> = BaseValueValidators<TModel, TValue> & {
...
export declare type StringValueValidators<TModel, TValue extends string | null | undefined> = {
...
export declare type NumberValueValidators<TModel, TValue extends number | null | undefined> = {
...
export declare type ObjectValueValidators<TModel, TValue extends object | null | undefined> = {
