...
const utils_1 = require("@layer0/core/utils");
...
function renderNextPage(page, responseWriter, params, options = { rewritePath: true }) {
    if (!environment_1.isCloud() && !warnedOfDeprecation) {
        const config = utils_1.nonWebpackRequire(path_1.join(process.cwd(), 'next.config.js'));
 ...
 */
async function _renderNextPage(page, responseWriter, params, options = { rewritePath: true }) {
