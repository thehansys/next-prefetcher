...
module.exports = function transformNextConfig(fileInfo, api) {
    ...
    const layer0NextConfigRoot = j(fs_extra_1.readFileSync(path_1.join(__dirname, '..', 'default-app', 'all', 'next.config.js')).toString());
    const l0DefaultExport = layer0NextConfigRoot.find(j.AssignmentExpression, node => { var _a, _b, _c, _d; return ((_b = (_a = node.left) === null || _a === void 0 ? void 0 : _a.object) === null || _b === void 0 ? void 0 : _b.name) === 'module' && ((_d = (_c = node.left) === null || _c === void 0 ? void 0 : _c.property) === null || _d === void 0 ? void 0 : _d.name) === 'exports'; });
    const withServiceWorkerExpr = layer0NextConfigRoot.find(j.CallExpression, expr => expr.callee.name === 'withServiceWorker');
