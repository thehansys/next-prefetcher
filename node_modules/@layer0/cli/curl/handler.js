...
var _printLayer0Telemetry = _interopRequireDefault(require("./print/printLayer0Telemetry"));

var _printCurlTimingTable = _interopRequireDefault(require("./print/printCurlTimingTable"));

var _printLayer0Version = _interopRequireDefault(require("./print/printLayer0Version"));
...
async function handler(userCurlArgs, internalArgs, {
  ...
  await (0, _printLayer0Version.default)(curlResponse, printerContext);
  await (0, _printLayer0Telemetry.default)(curlResponse, printerContext);
