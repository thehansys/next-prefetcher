...
class EdgeResponseWriter extends ResponseWriter_1.default {
    ...
    constructor(_req, _res, route, context) {
        ...
        this.setRequestHeader = (name, value) => {
            validate_1.validateHeaderSet({ name, value }, "setRequestHeader");
        ...
        this.addResponseCookie = (name, value) => {
            validate_1.validateCookieAdd({ name, value }, "addResponseCookie");
            this.edgeConfig.transform.response.push({
        ...
        this.addUpstreamResponseCookie = (name, value) => {
            validate_1.validateCookieAdd({ name, value }, "addUpstreamResponseCookie");
            this.edgeConfig.transform.upstreamResponse.push({
                action: constants_1.ACTIONS.addCookie,
                name,
                value,
        ...
        this.serveStatic = (path, options = {}) => {
            const { permanent, exclude, onNotFound, loadingPage, expiresSeconds, statusCode, statusMessage, } = options;
        ...
        this.verifyJwt = (options) => {
            validate_1.validateVerifyJwt(options);
        ...
        this.proxy = (backend, options = {}) => {
            const { path, transformResponse, transformRequest } = options;
         ...
         */
        this.cache = (config) => {
            validate_1.validateCache(config);
