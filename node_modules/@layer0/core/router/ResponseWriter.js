...
class ResponseWriter extends BaseResponseWriter_1.BaseResponseWriter {
    ...
    constructor(req, res, route, context) {
        ...
        this.redirect = (to, options = {}) => {
            validate_1.validateRedirect({ to, options });
        ...
        this.proxy = async (backend, options) => {
            validate_1.validateProxy({ backend, options });
         ...
         */
        this.renderWithApp = (options) => {
            validate_1.validateRenderWithApp({ options });
            this.proxy(constants_1.BACKENDS.js, options);
        };
        /**
         ...
         */
        this.stream = (backend) => {
            validate_1.validateStream({ backend });
         ...
         * @param options
         */
        this.proxyHost = async (backendConfig, options = {}) => {
            const { path, transformRequest, transformResponse, headers, removeEmptySearchParamValues, } = options;
            validate_1.validateProxyHost({ backendConfig, options });
        ...
        this.updatePath = (destination) => {
            validate_1.validateUpdatePath({ destination });
        ...
        this.rewrite = (destination, pattern) => {
            validate_1.validateRewrite({ destination, pattern });
            const path = bindParamsToPath_1.default(destination, this.request.params);
        ...
        this.serveStatic = async (path, options = {}) => {
            validate_1.validateServeStatic({ path, options });
         ...
         */
        this.cache = (options) => {
            validate_1.validateCache(options);
        ...
        this.setResponseHeader = (name, value) => {
            validate_1.validateHeaderSet({ name, value }, "setResponseHeader");
        ...
        this.updateResponseHeader = (name, match, replace) => {
            validate_1.validateHeaderUpdate({ name, match, replace }, "updateResponseHeader");
        ...
        this.removeResponseHeader = (name) => {
            validate_1.validateHeaderRemove({ name }, "removeResponseHeader");
        ...
        this.addUpstreamResponseCookie = (name, value, options) => {
            validate_1.validateCookieAdd({ name, value, options }, "addUpstreamResponseCookie");
        ...
        this.addResponseCookie = (name, value, options) => {
            validate_1.validateCookieAdd({ name, value, options }, "addResponseCookie");
        ...
        this.updateUpstreamResponseCookie = (name, match, replace) => {
            validate_1.validateCookieUpdate({ name, match, replace }, "updateUpstreamResponseCookie");
        ...
        this.updateResponseCookie = (name, match, replace) => {
            validate_1.validateCookieUpdate({ name, match, replace }, "updateResponseCookie");
        ...
        this.removeUpstreamResponseCookie = (name) => {
            validate_1.validateCookieRemove({ name }, "removeUpstreamResponseCookie");
        ...
        this.removeResponseCookie = (name) => {
            validate_1.validateCookieRemove({ name }, "removeResponseCookie");
        ...
        this.setUpstreamResponseHeader = (name, value) => {
            validate_1.validateHeaderSet({ name, value }, "setUpstreamResponseHeader");
        ...
        this.updateUpstreamResponseHeader = (name, match, replace) => {
            validate_1.validateHeaderUpdate({ name, match, replace }, "updateUpstreamResponseHeader");
        ...
        this.removeUpstreamResponseHeader = (name) => {
            validate_1.validateHeaderRemove({ name }, "removeUpstreamResponseHeader");
        ...
        this.updateRequestHeader = (name, match, replace) => {
            validate_1.validateHeaderUpdate({ name, match, replace }, "updateRequestHeader");
            this.scheduleExecution(this.postCacheRequestActions, () => {
        ...
        this.removeRequestHeader = (name) => {
            validate_1.validateHeaderRemove({ name }, "removeRequestHeader");
            this.scheduleExecution(this.postCacheRequestActions, () => {
        ...
        this.serviceWorker = (path) => {
            validate_1.validateServiceWorker({ path });
            this.cache({
                edge: {
        ...
        this.appShell = (indexHtmlPath) => {
            validate_1.validateAppShell({ indexHtmlPath });
        ...
        this.allowCors = (config = {}) => {
            validate_1.validateAllowCors(config);
        ...
        this.send = (content, statusCode = 200, statusMessage) => {
            validate_1.validateSend({ content, statusCode, statusMessage });
        ...
        this.compute = (callback) => {
            validate_1.validateCompute({ callback });
            this.setCreateResponseAction(async () => {
