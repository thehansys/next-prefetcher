    ...
    return (
        <div className={styles.container}>
            ...
            <main className={styles.main}>
                ...
                <img src="/img/small/1.jpg" width="500" height="500" alt="img1" className="prefetched" />
                <p>
                ...
                <img src="/img/small/2.jpg" width="500" height="500" alt="img2" className="prefetched" />
                <p>
                ...
                <img src="/img/small/3.jpg" width="500" height="500" alt="img3" className="prefetched" />
                <p>
